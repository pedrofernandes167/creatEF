...
namespace Codenation.Challenge.Models
{
    public class UserConfig : IEntityTypeConfiguration<User>
    {
        ...
        public void Configure(EntityTypeBuilder<User> user)
        {
            ...
            user.Property(u => u.Password).HasColumnName("password").HasMaxLength(255).IsRequired();
            user.Property(u => u.Created_At).HasColumnName("created_at").IsRequired();

            user.HasMany(u => u.Candidates).WithOne();
            user.HasMany(u => u.Submissions).WithOne();
        }
    }
}
